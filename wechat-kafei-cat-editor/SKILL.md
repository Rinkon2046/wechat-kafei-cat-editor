...
- 咖啡猫是一只参考 `assets/kafei-cat-black-exotic-reference.png` 的黑色异国短毛/黑色加菲感手绘猫：圆胖扁脸、低鼻梁、短小圆耳、厚实绒毛轮廓、圆滚身体、短爪短腿、粗蓬尾巴、金黄色大圆眼带小白高光，表情空白但认真。它可以是极简黑色手绘角色，但必须保留扁脸、金眼、绒毛团块和敦实比例这几个识别点。
...
- 不要画成橙色加菲猫式版权形象、虎斑猫、白猫、长嘴尖脸猫、商业吉祥物、儿童卡通猫、穿复杂衣服的猫或过度卖萌的猫。允许金色圆眼有明显高光，但整体气质要冷静、专注、略怪，像黑色扁脸操作员。
...
`assets/kafei-cat-black-exotic-reference.png` 是咖啡猫角色外形校准图，只用于理解黑色扁脸、金色圆眼、厚实绒毛和敦实比例；生成最终图时不要照搬照片构图、摄影背景、水印、写实毛发或真实宠物肖像。最终仍必须是白底、手绘、解释型的 Ian 风格咖啡猫插图。
...
Kafei Cat, an original black exotic-shorthair / black Garfield-like coffee cat inspired by assets/kafei-cat-black-exotic-reference.png: solid black fluffy body, round flat face, tiny rounded ears, low nose bridge, short paws, tiny legs, thick plush tail, large golden round eyes with small white highlights, blank serious expression, slightly uneven marker-filled hand-drawn silhouette. Kafei Cat must perform the core conceptual action, not decorate the scene. Make it serious, deadpan, and slightly bizarre, not cute. Do not draw an orange Garfield-like copyrighted cat, tabby cat, white cat, or pointy long-muzzled cat; this is an original black coffee cat.
...
Kafei Cat required:
A small solid-black original coffee cat inspired by assets/kafei-cat-black-exotic-reference.png: black exotic-shorthair / black Garfield-like proportions, round flat face, tiny rounded ears, low nose bridge, short paws, tiny legs, thick plush tail, large golden round eyes with small white highlights, blank serious expression, slightly uneven body shape, and subtle marker-fill texture. It must act out the article's central tension, not pose beside a title.
...
- 没有任何生成图像橙色加菲猫式版权形象、普通尖脸小黑猫、白猫、虎斑猫、商业吉祥物、儿童插画、正式流程图、课程页或 PPT 信息图；咖啡猫应保留黑色扁脸、金色圆眼、厚实绒毛和敦实比例。
